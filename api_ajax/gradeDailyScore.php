...
if (isset($_SESSION['dailyLoginGraded']) && $_SESSION['dailyLoginGraded']) {
    if($_SESSION['dailyLoginDate'] == date('Y-m-d')){
...
$apiResponse = api_request_post('saveDailyLogin', $profileData, 'POST', $accessToken,$refreshToken);

//$apiResponse = api_request('profileSetup', $profileData, 'POST', $accessToken);

if ($apiResponse['success']) {
    $_SESSION['dailyLoginGraded'] = true;
    $_SESSION['dailyLoginDate'] = date('Y-m-d');
}
